...
- Never claim that memory was saved, updated, or deleted unless the corresponding tool call succeeded. If a mutation fails, report the failure and retry after the required live read.
